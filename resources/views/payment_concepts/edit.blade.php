        ...
        <div class="container-fluid">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form method="POST"
                          action="{{ route('payment_concepts.update', $payment_concept->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre"
                                   value="{{ $payment_concept->nombre }}"
                                   class="form-control" required>
                        </div>

                        <div class="form-group mt-3">
                            <div class="form-check">
                                <input type="checkbox" name="es_mensual" id="es_mensual" value="1"
                                       class="form-check-input"
                                       {{ $payment_concept->es_mensual ? 'checked' : '' }}>
                        ...
                        <div class="form-group mt-3">
                            <div class="form-check">
                                <input type="checkbox" name="activo" id="activo" value="1"
                                       class="form-check-input"
                                       {{ $payment_concept->activo ? 'checked' : '' }}>
